...
var Icons = [
    ...
    `<svg id="HomeHeadNavigationButtonSvg" width="162" height="30" viewBox="0 0 162 30" fill="none"><rect y="13.4583" width="18" height="2.58333" fill="var(--Black)"/><rect y="7" width="11.5714" height="2.58333" fill="var(--Black)"/><rect x="6.42847" y="19.9166" width="11.5714" height="2.58333" fill="var(--Black)"/><text fill="var(--Black)" xml:space="preserve" style="white-space: pre" font-family="ManropeSemiBold" font-size="22" letter-spacing="0em"><tspan x="41" y="23.25">Navigation</tspan></text></svg>`,
    ...
    `<svg id="HomeFeaturedSubtitleSvg" height="33" viewBox="0 0 116 33" fill="none"><text opacity="0.3" fill="var(--Black)" xml:space="preserve" style="white-space: pre" font-size="24" letter-spacing="0em"><tspan x="0" y="25.5">PLANNER</tspan></text></svg>`,

    `<svg id="HomeFeaturedTitle1Svg" height="100" viewBox="0 0 386 100" fill="none"><rect y="60" width="181" height="40" fill="var(--Light)"/><text fill="var(--Black)" xml:space="preserve" style="white-space: pre" font-size="80" letter-spacing="0em"><tspan x="0" y="80">Plan your</tspan></text></svg>`,

    `<svg id="HomeFeaturedTitle2Svg" height="100" viewBox="0 0 462 100" fill="none"><text fill="var(--Black)" xml:space="preserve" style="white-space: pre" font-size="80" letter-spacing="0em"><tspan x="0" y="80">future, and</tspan></text></svg>`,

    `<svg id="HomeFeaturedTitle3Svg" height="100" viewBox="0 0 436 100" fill="none"><rect y="60" width="233" height="40" fill="var(--Light)"/><text fill="var(--Black)" xml:space="preserve" style="white-space: pre" font-size="80" letter-spacing="0em"><tspan x="0" y="80">recall past</tspan></text></svg>`
